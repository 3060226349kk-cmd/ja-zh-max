...
以上三个框架的决策结果汇入 text-profile，写入对照文件头部。产出标准。
...
**2. 译文修改分层框架**（预载方法论）— 在标准的三层修改（篇章→句子→词汇）基础上增加第四层：
- 篇章层：段落间衔接、信息流
- 句子层：语法结构、长修饰分割
- 词汇层：和製漢語陷阱、选词精准度
- **修辞层（★ 新增）**：辞格处理、敬语降维、文体审美一致性

四层修改的产出替代原有的三层修改清单。修改记录在阶段 8A 清理时删除。
...
1. **剥夺版本标记** — 删除所有内部工序标记：
   - 版本标记：`[v1]`、`[v2·S]`、`[v2·W]`、`[v2·A]`、`[v2·∅]`、`[v3]`、`[v3·Q✓]`
